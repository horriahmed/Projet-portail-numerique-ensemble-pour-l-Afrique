 ...
 */
@WebServlet("/downloadFormulaire")
public class DownloadFormulaire extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private static final int DEFAULT_BUFFER_SIZE = 10240; // 10 ko
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DownloadFormulaire() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
	        /* Ouvre les flux */
	        entree = new BufferedInputStream( new FileInputStream( fichier ), 100 );
	        sortie = new BufferedOutputStream( response.getOutputStream(), 100);
