 ...
 */
public class ListUtilisateurAdministrateur extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ListUtilisateurAdministrateur() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			this.getServletContext().getRequestDispatcher("/WEB-INF/ListUtilisateur/ListUtilisateurAdministrateur.jsp" ).forward( request, response );
