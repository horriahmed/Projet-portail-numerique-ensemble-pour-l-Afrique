...
@WebServlet("/refreshCategory")

@MultipartConfig

public class RefreshCategory extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ForumS.insertTheme(request, response, request.getParameter("msg"), Integer.toString(nomFichier.hashCode()) + "."+ fileName.split(pattern)[fileName.split(pattern).length - 1 ].split("\\.")[1]) ;
