...
<body>
	...
	ArrayList<Theme> thm = (ArrayList<Theme>) request.getAttribute("themeUser") ;
	%>
	<main class="site-main">
		<section class="mb-30px">
			<div class="container">
				<div class="hero-banner"
					style="background-image:url('http://localhost/Images/<%out.print(mesSujet.get(0).getLinkTheme());%>'); background-size: cover;">
					<div class="hero-banner__content">
						...
						<h1>
							<%
								out.println(mesSujet.get(0).getNomTheme());
							%>
						</h1>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 sidebar-widgets">
              ...
              for(Theme un : mesTheme){
            	  out.print("<ul class=\"cat-list mt-20\"><li><a href=\"http://localhost:8080/EnsemblePourAfrique/sujet?id=" + un.getId()+"\" class=\"d-flex justify-content-between\"><p>" + un.getNom() + "</p></a></li>") ; 
              }
